...
<head>
    ...
    <title>要就业-${model.courseBase.name}</title>
...
<div class="article-banner">
    ...
    <div class="banner-info">
        ...
        <div class="banner-rit">
            <p>
                <a href="http://www.yaojiuye.cn/course/preview/learning.html?id=${model.courseBase.id}" target="_blank">
                    <#if model.courseBase.pic??>
                        <img src="http://file.yaojiuye.cn${model.courseBase.pic}" alt="" width="270" height="156">
                    <#else>
                            ...
                            <div class="cont">
                                <#if model.courseTeachers??>
                                    <#list model.courseTeachers as teacher>
                                        <div class="img-box">
                                            <img src="http://file.yaojiuye.cn${teacher.photograph!''}" alt="${teacher.teacherName}" width="128" height="128">
                                        </div>
                                        <div class="info-box">
                                            <p class="name">教师名称：<em>${teacher.teacherName!''}</em></p>
                                            <p class="name">教师职位: <em>${teacher.position!''}</em></p>
                                            <p class="name">教师简介: <em>${teacher.introduction!''}</em></p>
                                        </div>
                                    </#list>
                                <#else>
                                    <p>暂无教师信息</p>
                                    ...
                                    <ul class="list-box">
                                        <#list firstNode.teachPlanTreeNodes as secondNode>
                                            <#if secondNode.teachplanMedia??>
                                                <li><a href="http://www.yaojiuye.cn/course/preview/learning.html?id=${model.courseBase.id}&chapter=${secondNode.teachplanMedia.teachplanId!''}" target="_blank">${secondNode.pname}</a></li>
                                            <#else>
                                                <li><a href="http://www.yaojiuye.cn/course/preview/learning.html?id=${model.courseBase.id}" target="_blank">${secondNode.pname}</a></li>
                                            </#if>
                                        </#list>
                                    </ul>
                                </div>
