...
import com.yaojiuye.messagesdk.mapper.MqMessageMapper;
...
public class MqMessageServiceImpl extends ServiceImpl<MqMessageMapper, MqMessage> implements MqMessageService {
    ...
    public int completed(long id) {
        ...
        if(update>0){
            ...
            BeanUtils.copyProperties(mqMessage,mqMessageHistory, "state");
            String state = mqMessage.getState();
            mqMessageHistory.setState(Integer.valueOf(state));
