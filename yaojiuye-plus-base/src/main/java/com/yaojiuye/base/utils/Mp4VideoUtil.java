package com.yaojiuye.base.utils;
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "G:\\code_tzn\\soft\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "G:\\java进阶\\2、黑马程序员Java项目《学成在线》企业级开发实战\\学成在线项目—视频\\day01 项目介绍&环境搭建\\Day1-00.项目导学_2.avi";
        //转换后mp4文件的名称
        String mp4_name = "Day1-00.项目导学_3.mp4";
        //转换后mp4文件的路径
        String mp4_path = "G:\\java进阶\\2、黑马程序员Java项目《学成在线》企业级开发实战\\学成在线项目—视频\\day01 项目介绍&环境搭建\\";
        //创建工具类对象
